...
function addThongKe() {
    ...
    danhSachDonHang.forEach(donHang => {
        ...
        donHang.sp.forEach(sanPhamTrongDonHang => {
            let tenHang = sanPhamTrongDonHang.sanPham.phanloai;
...
function addKhungSuaSanPham(masp) {
    ...
    var company = ["BanhNgot", "BanhSinhNhat", "BanhMi", "BanhMan"];
    ...
    s += `
        ...
        <tr>
            <td>Khu vực:</td>
            <td><input type="text" value="`+sp.detail.area+`"></td>
        </tr>
        <tr>
            <td>Phân loại:</td>
            <td><input type="text" value="`+sp.detail.tags+`"></td>
        </tr>
        <tr>
            <td>Mô tả:</td>
            <td><input type="text" value="`+sp.detail.describe+`"></td>
        </tr>
