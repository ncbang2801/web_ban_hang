	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="danhsachcuahang.html"><i class="fa fa-wrench"></i> Danh sách cửa hàng</a></li>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Trang chủ Tiệm bánh" title="Trang chủ Tiệm bánh">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Calem</a> - All rights reserved © 2021 - Designed by
            <span style="color: #eee; font-weight: bold">NCB</span></p>
    </div>`);
}
